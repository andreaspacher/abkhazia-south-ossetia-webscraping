...
url <- "http://mfaapsny.org/en/allnews/news/visits_info/"
...
for(i in 1:page_nr) {
  ...
  printtext <- paste(i, "Abkhazia | Visits & Trips", sep = ": ")
  print(printtext)
  
  scrape_url <- paste0("http://mfaapsny.org/en/allnews/news/visits_info/?PAGEN_1=", i)
  ...
  dfs[[i]] <- do.call(rbind, Map(data.frame,
                                 ...
                                 URL = scrape_url,
                                 News_type = "Information about Visits and Trips",
...
readr::write_csv(DF, "02_ABKH_Visits_and_Trips.csv")
