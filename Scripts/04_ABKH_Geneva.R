...
url <- "http://mfaapsny.org/en/allnews/news/geneva-discussions/"
...
for(i in 1:page_nr) {
  ...
  printtext <- paste(i, "Abkhazia | Geneva Discussions", sep = ": ")
  print(printtext)
  
  scrape_url <- paste0("http://mfaapsny.org/en/allnews/news/geneva-discussions/?PAGEN_1=", i)
...
readr::write_csv(DF, "04_ABKH_Geneva.csv")
