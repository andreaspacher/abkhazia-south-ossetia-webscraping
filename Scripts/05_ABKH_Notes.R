...
url <- "http://mfaapsny.org/en/allnews/news/notes/"
...
for(i in 1:page_nr) {
  ...
  printtext <- paste(i, "Abkhazia | Notes", sep = ": ")
  print(printtext)
  
  scrape_url <- paste0("http://mfaapsny.org/en/allnews/news/notes/?PAGEN_1=", i)
...
readr::write_csv(DF, "05_ABKH_Notes.csv")
